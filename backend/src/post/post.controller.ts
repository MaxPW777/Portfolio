...
export class PostController {
  ...
  @UseGuards(JwtAuthGuard)
  @Put('edit/:id')
  public async edit(@Param('id') postId: string, @Body() editPostDto: EditPostDto, @Req() req): Promise<IPostDocument> {
  ...
  @UseGuards(JwtAuthGuard)
  @Delete('delete/:id')
  public async delete(@Param('id') postId: string): Promise<IPostDocument> {
